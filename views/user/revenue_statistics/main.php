...
<div id="sidebar-collapse" class="box1 col-md-6 col-lg-2">
    <div class="list-group" >
        ...
        <a href="?controller=user&redirect=revenue_statistics" class="list-group-item list-group-item-action" id="maincolor">Revenue Statistics</a>
...
<div class="box1 col-md-6 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="container">
            ...
            <h3><b>Tổng doanh số: <?= $arr['result'] ?></b></h3>
        </div>
    </div>
</body>
</html>
